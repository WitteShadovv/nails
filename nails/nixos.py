...
class NixOSManager:
    ...
    def switch_to_previous_generation(self):
        ...
        try:
            ...
            switch_result = subprocess.run([
                "nix-env", "--switch-generation", str(previous_gen),
    ...
    def _verify_hidden_system(self):
    ...
    def _check_service_status(self, service: str):
        ...
        try:
            ...
            print(f"  ℹ️ Could not check {service} service status")

    def _check_package_availability(self, package: str):
        ...
        try:
            ...
            print(f"  ℹ️ Could not verify {package} installation")

    def _check_user_creation(self, username: str):
        ...
        try:
            ...
            print(f"  ℹ️ Could not verify {username} user creation")
